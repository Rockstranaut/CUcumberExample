/*Administration
Database Users
//*[@id="R162627621263759065"]/tbody/tr/td[2]/input
id=P2611_USERNAME
id=P2611_PASSWORD
id=P2611_CONFIRM_PASSWORD
xpath=//*[@id="R162638405127839537"]/thead/tr/th[2]/input[2]
*/

package com.lti.stepdefinition;
...
public class StepsForCreate {
	...
	public void user_enters_username_Password(String s11,String s22) {
		 driver.findElement(By.id("P11_USERNAME")).sendKeys(s11);
		  driver.findElement(By.id("P11_PASSWORD")).sendKeys(s22);
	...
	public void enter_New_Username_new_Password_Confirm_Password() {
		
	  driver.findElement(By.id("P2611_USERNAME")).sendKeys("shruti");
	  driver.findElement(By.id("P2611_PASSWORD")).sendKeys("shruti123");
	  driver.findElement(By.id("P2611_CONFIRM_PASSWORD")).sendKeys("shruti123");
	}
